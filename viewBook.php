...
<body style='background-image: linear-gradient(21deg, rgba(64, 83, 206, 0.3697003235) 68%, rgba(255, 206, 196, 0.5) 163%), linear-gradient(163deg, rgba(49, 146, 170, 0.0794448997) 86%, rgba(239, 112, 138, 0.5) 40%), linear-gradient(30deg, rgba(76, 79, 173, 0.6173675717) 22%, rgba(237, 106, 134, 0.5) 169%), linear-gradient(48deg, rgba(31, 85, 147, 0.7323890642) 64%, rgba(247, 126, 132, 0.5) 43%);
	...
	<div class='MainContainor'>
		...
		<div class='mainproduct'>
				<div class='catagory'><div class='displayImage' style='background-image: url(Fantasy.jpg); '></div><div class='displayCatagory' style='background: #709acc'><div class='displayTitle' s>$bkName</div><div class='quoatTitle' style='right: -10px;'>See your Imaginations.</div></div></div>
				<div class='catagory' style='background-color: #88abd5;
    height: 350px;
    padding-top: 40px;	
    font-size: 20px;
    border-radius: 10px;'>Name : $bkName <br><br><br> Auther Name: $autherName <br><br><br>Price is $price <br><br><br>Quantity available is $qty <br><br><br> Book Id: $id  <br><br> </div>
				<div class='catagory'></div>
		</div>
		<!-- // <a href='AdminBookSection.php'>
		// 	<div class='button-01'>
		// 		<div class='button-content'>Go to Book Section</div>
		// 	</div>
		// </a>		-->			
